    ...
    process
    {
        @{
            ...
            Patrons = @(
                ...
                'Руслан Артамонов', 'Сергей Бензенко', 'Лазарев Илья', 'Шевченко Антон',
                'Ольга Бондаренко', 'Сергей Краснов', 'Константин Ушаков',
                'Андрей Фазлеев', 'Дмитрий Павлов', 'Постарнаков Андрей', 'Дмитрий Сорокин'
                'Александр Ерыгин', 'Егор Сычёв', 'Гольдебаев Александр')
        }
    }
}
